...
@SVAR_8 =  constant [2 x i8] c"\0a\00", align 1
...
define void @intelligence_test(double %farg_x_23, double* %pi_15, i32* %z_14)
{
	intelligence_testmain:
		...
		%x_23_5 = load double, double* %x_23
		%R_6 = call double (double, double*, i32*) @area(double %x_23_5, double* %pi_15, i32* %z_14)
		call void (double) @lambda7c_printfloat(double %R_6)
		%A_8 = getelementptr inbounds [2 x i8], [2 x i8]* @SVAR_8, i64 0, i64 0
		call void (i8*) @lambda7c_printstr(i8* %A_8)
		ret void
